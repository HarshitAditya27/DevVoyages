...
test("should edit hotel", async ({ page }) => {
  ...
  await expect(page.locator('[name="name"]')).toHaveValue("Radison Blu");
  await page.locator('[name="name"]').fill("Radison Blu UPDATED");
  await page.getByRole("button", { name: "Save" }).click();
  await expect(page.getByText("Hotel Saved!")).toBeVisible();
  ...
  await page.locator('[name="name"]').fill("Radison Blu");
  await page.getByRole("button", { name: "Save" }).click();
});
